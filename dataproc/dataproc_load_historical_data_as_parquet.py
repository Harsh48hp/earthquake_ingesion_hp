...
if __name__ == '__main__':
    try:
        ...
        table_id = f"{project_id}.{dataset_id}.flattened_historical_data_by_parquet"
...
# gcloud dataproc jobs submit pyspark gs://earthquake_analysis_by_hp_24/pyspark_dataproc/bronze/dataproc_load_historical_data_as_parquet.py --cluster=harshal-bwt-session-dataproc-cluster-24 --region=us-central1 --files=gs://earthquake_analysis_by_hp_24/pyspark_dataproc/bronze/util.py,gs://earthquake_analysis_by_hp_24/pyspark_dataproc/bronze/dynamic_methods.py --properties="spark.executor.memory=2g,spark.driver.memory=2g"
